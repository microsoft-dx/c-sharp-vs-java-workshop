...
public class ClassesDemo {
    public static void main (String[] args) {
        Politician pol1 = new Politician("Liviu", "Dragnea", "PSD");
        Politician pol2 = new Politician("Viorica", "Dancila", "PSD");
        Politician pol3 = new Politician("Calin", "Popescu-Tariceanu", "ALDE");
        Politician pol4 = new Politician("Ioan Cezar", "Coraci"); // stiu ca era la PNL, dar bag si eu asa
        ...
        System.out.println(pol1.steal);
        System.out.println(pol2.steal);
        System.out.println(pol3.steal);
        System.out.println(pol4.steal);
